  ...
  return (
    <div>
      <div className="contact ">
        <div className="">
          <div className="row messageRow">
            ...
            <div className="col-md-7">
              <div className="imgOuterDiv">
                <img src={img2} className="borderImg" />
                <img className="imgDiv" src={img1} />
              </div>
            </div>
          </div>
          <div className="row maprow ">
            <div className="col-md-7">
              <div className="map">
                <img src={img2} className="mapborderImg" />
              ...
              <div className="contact-form">
                <div className="">
                  ...
                  <div className="form-body ">
                    ...
                    <span className="mobilenumberSection">
                      <select
      ...
      <div className="footer">
        <footer>afnfgnnnnnnnnnnnnnbcd</footer>
      </div>
    </div>
  );
};
